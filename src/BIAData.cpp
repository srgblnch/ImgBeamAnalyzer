...
BIAData::BIAData (void)
  : SharedObject (),
    ...
    gaussfit_major_converged(false),
	gaussfit_minor_converged(false),
	gaussfit_major_axis_fwhm(0),
    gaussfit_minor_axis_fwhm(0),
	gaussfit_major_axis_1e2(0),
	gaussfit_minor_axis_1e2(0),
	gaussfit_major_axis_order(2),
	gaussfit_minor_axis_order(2),
	gaussfit_major_axis_mag(0),
	gaussfit_minor_axis_mag(0),
	gaussfit_major_axis_center(0),
	gaussfit_minor_axis_center(0),
	gaussfit_major_axis_flat(0),
	gaussfit_minor_axis_flat(0),

    gaussfit_tilt(0),
	gaussfit_ellipticity(0),
	gaussfit_eccentricity(0),
	gaussfit_flat_X(0),
	gaussfit_flat_Y(0),
    gaussfit_bg(0),
    gaussfit_chi2(0),
