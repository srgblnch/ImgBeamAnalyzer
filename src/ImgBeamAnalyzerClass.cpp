...
void ImgBeamAnalyzerClass::attribute_factory(vector<Tango::Attr *> &att_list)
{
	...
	pixel_size_x_prop.set_unit("�m/pix");
	...
	pixel_size_y_prop.set_unit("�m/pix");
	...
	chamber_offset_x_prop.set_unit("�m");
	...
	chamber_offset_y_prop.set_unit("�m");
	...
	xproj_fit_center_prop.set_unit("�m");
	...
	xproj_fit_sigma_prop.set_unit("�m");
	...
	xproj_fit_fwhm_prop.set_unit("�m");
	...
	yproj_fit_center_prop.set_unit("�m");
	...
	yproj_fit_sigma_prop.set_unit("�m");
	...
	yproj_fit_fwhm_prop.set_unit("�m");
	...
	gaussian_fit_center_x_prop.set_unit("�m");
	...
	gaussian_fit_center_y_prop.set_unit("�m");
	...
	gaussian_fit_variance_x_prop.set_unit("�m�");
	...
	gaussian_fit_variance_y_prop.set_unit("�m�");
	...
	gaussian_fit_covariance_xy_prop.set_unit("�m�");
	...
	gaussian_fit_major_axis_fwhm_prop.set_unit("�m");
	...
	gaussian_fit_minor_axis_fwhm_prop.set_unit("�m");
...
void ImgBeamAnalyzerClass::set_default_property()
{
	...
	prop_name = "CleanCurrentDataOnError";
	prop_desc = "If true then current data will be deleted when IBA's state turn to FAULT";
	prop_def  = "";
	vect_data.clear();
	if (prop_def.length()>0)
	{
